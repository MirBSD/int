...
set -- -Wall -Wextra -Wformat \
    -Werror=format-security -Og -fstack-protector-strong \
    -fsanitize=address -fno-omit-frame-pointer -fno-common \
    -fsanitize=pointer-compare -fsanitize=pointer-subtract \
    -fsanitize=undefined -fsanitize=shift -fsanitize=shift-exponent \
    -fsanitize=shift-base -fsanitize=integer-divide-by-zero \
