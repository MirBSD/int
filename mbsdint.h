...
#define SYSKERN_MBSDINT_H "$MirOS: src/kern/include/mbsdint.h,v 1.29 2023/03/26 17:20:55 tg Exp $"
...
#undef mbiCTf
 ...
 mbiCTA(basic_large,
	...
	((mbiLARGE_MIN) == -(mbiLARGE_MAX)) == ((SCHAR_MIN) == -(SCHAR_MAX)) &&
 ...
 mbiCTA(basic_huge,
	...
	((mbiHUGE_MIN) == -(mbiHUGE_MAX)) == ((SCHAR_MIN) == -(SCHAR_MAX)) &&
